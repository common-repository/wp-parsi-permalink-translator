...
class WPPPT_Plugin
{
    ...
    function translate($text)
    {
        ...
        if (isset($response['d']['results'][0]['Text']) && $response['d']['results'][0]['Text'] != '')
    ...
    function settings_page()
    {
        ...
        $ignore_post_types = array("attachment", "revision", "nav_menu_item", "custom_css","customize_changeset");
        ...
        <div class="wrap wpppt_wrap">
            ...
            <form action="" method="post">
                <table border="0">
                    <tr>
                        ...
                        <td><input type="text" name="key" placeholder="" value="<?php echo $opt['key'] ?>" class="ltr"/>
            ...
            <hr/>
            <a href="http://parsa.ws" target="_blank"><?php _e("Parsa Web Developer", $this->text_domain) ?></a>
